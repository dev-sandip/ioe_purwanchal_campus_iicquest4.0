...
- **`nepali_correction_best.pth`**: The notebook-trained `NepaliCorrectionModel` (`embed_dim=64`, `hidden_dim=128`, `num_layers=2`, `max_len=100`) proposing candidate spell corrections.

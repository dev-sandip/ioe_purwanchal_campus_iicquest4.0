...
Examples:
  ...
  python fl/main.py client --server localhost:8080 --client-id 1 \\
    --batch-size 64 --csv data/nepali_correction_pairs.csv
        """,
    )
    ...
    client_parser.add_argument(
        "--csv",
        default="data/nepali_correction_pairs.csv",
        help="Path to CSV with correction pairs (default: data/nepali_correction_pairs.csv)",
    )
    client_parser.add_argument(
        "--tokenizer",
        default="data/nepali_char_tokenizer.json",
        help="Path to tokenizer JSON (default: data/nepali_char_tokenizer.json)",
    )
    client_parser.add_argument(
        "--batch-size",
        type=int,

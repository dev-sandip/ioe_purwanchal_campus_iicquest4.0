  ...
  return (
    <main className="min-h-screen bg-[#f5f5f5] p-8">
      <div className="mx-auto max-w-[700px]">
        ...
        <textarea
          className="w-full min-h-[200px] rounded-lg border border-gray-300 p-4 text-base focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500/20 resize-y"
